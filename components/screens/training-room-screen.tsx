    ...
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-8">
            ...
            <Card className="px-6 py-3 flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-muted-foreground">Your Athlete</p>
            ...
            <div className="space-y-4">
              {TRAINING_STATS.map((stat) => (
                <TrainingSlider
                  ...
                  value={sliders[stat]}
                  onChange={(value) =>
                    onUpdateSliders({ ...sliders, [stat]: value })
                  }
                />
              ))}
            </div>
            ...
            <div className="space-y-2 pt-4 border-t">
              ...
              {budgetStatus === "caution" && (
                <p className="text-xs text-chart-4">
                  Too focused on one area. Try spreading your time!
                </p>
              )}
            </div>
          </Card>
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6 space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Their strengths (counter!) and weaknesses (exploit!)
                </p>
              </div>
        ...
        <div className="flex justify-center gap-4 pt-4">
          <Button size="lg" onClick={onFight} className="text-lg px-12 py-6">
            Fight! 🥊
          </Button>
        </div>
      </div>
